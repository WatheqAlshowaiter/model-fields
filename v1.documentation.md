![Package cover](./arts/old-package-cover.png)
...
> [!Note]  
> This is the documentation for version 1, if you want the latest version documentation go with [this link](./README.md).
...
```sh
composer require watheqalshowaiter/model-required-fields "^1.0" --dev
```
...
I encourage you to look at [Issues](https://github.com/WatheqAlshowaiter/model-required-fields/issues) which are the most important features that need to be added.
